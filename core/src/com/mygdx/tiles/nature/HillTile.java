 ...
 */
public class HillTile extends TileOwnership implements TileWithGroundBuilding{
    public HillTile(TextureRegion textureRegion) {
        super(textureRegion, TileType.Hill);
    }
}
